    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-5">
          <input type="text" className="input input-disabled input-sm" value={userData?.fullName} disabled />
          <input type="text" className="input input-disabled input-sm" value={userData?.role} disabled />
          <input type="text" className="input input-disabled input-sm" value={userData?.email} disabled />
          <input type="text" className="input input-disabled input-sm" value={userData?.phone} disabled />
        </div>
        <div>
