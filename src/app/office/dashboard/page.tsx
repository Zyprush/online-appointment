...
import ApprovedAppointments from "./OfficeApprovedAppointment"; // Import the ApprovedAppointments component
import DeclinedAppointments from "./OfficeDeclinedAppointment"; // Import the DeclinedAppointments component
  ...
  return (
    <NavLayout>
      <div className="bg-white p-6 rounded-lg pt-5 flex flex-col h-full justify-start">
        <h2 className="text-2xl font-bold mb-4">{officeData?.office} Appointments</h2>
        <div className="mb-4">
          <button
